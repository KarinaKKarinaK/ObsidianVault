...
## Related Notes
- [[00 - Robotics MOC]] — full robotics knowledge base
- [[08 - Key Subfields & Concepts]] — RL for robots, sim-to-real, IsaacLab, VLAs, policy concepts
- [[02 - Recent Breakthroughs 2023–2025]] — Eureka paper context; π0, RT-2
- [[07 - Key Bottlenecks]] — data scarcity, manipulation difficulty, compute
- [[Robotics]] — Prompt2Policy project notes (sister file)
- [[Lecture 12 — Reinforcement Learning]] — MDP formalism, reward functions, PPO, Q-learning
- [[AI Agents - Core Components]] — LLM-as-judge, agent orchestration patterns