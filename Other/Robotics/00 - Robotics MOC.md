...
- [[Lecture 12 — Reinforcement Learning]] — RL theory: MDPs, policy gradients, Q-learning
- [[Lecture 13 — Transformers]] — transformer architecture behind VLA models
- [[Lecture 4 — Neural Networks & Backpropagation]] — neural network foundations
- [[AI Agents - Core Components]] — agent architectures; perception-reasoning-action loops
- [[LLMs]] — LLMs used in VLA models and robot task planning
- [[Transhumanism]] — philosophical context for where robotics is headed
