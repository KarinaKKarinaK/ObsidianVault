...
## Related Notes
- [[Lecture 5 — Deep Learning 1 (Autodiff & CNNs)]] — CNNs and autodiff building on neural net foundations
- [[Lecture 6 — Deep Learning 2 (Generative Models)]] — generative models using deep networks
- [[Lecture 13 — Transformers]] — transformers as the dominant neural architecture today
- [[Linear Algebra Notes]] — matrix math underlying neural networks
- [[Lecture 3 — Probabilistic Models]] — probabilistic perspective on neural net outputs
- [[09 - Machine Learning]] — applied ML using these foundations
