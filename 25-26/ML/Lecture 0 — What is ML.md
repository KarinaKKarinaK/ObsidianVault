...
## Related Notes
- [[Lecture 1 — Linear Models & Optimization]] — first concrete ML models
- [[09 - Machine Learning]] — applied ML for software engineering context
- [[Linear Algebra Notes]] — mathematical foundations for ML
- [[Stats Review]] — statistics foundations for ML (probability, distributions)
- [[Index - Artificial Intelligence]] — AI broader context
- [[08 - Key Subfields & Concepts]] — ML applied to robotics
