...
## Related Notes
- [[08 - Key Subfields & Concepts]] — VLA models (Vision-Language-Action): transformers applied to robot control
- [[02 - Recent Breakthroughs 2023–2025]] — RT-2, π0, Gemini Robotics: transformer-based robot models
- [[LLMs]] — LLMs are transformer-based; GPT, BERT, Claude architecture
- [[Lecture 9 — Sequential Models (Deep Learning on Sequences)]] — RNNs that transformers replaced
- [[Lecture 4 — Neural Networks & Backpropagation]] — neural network fundamentals transformers build on
- [[AI Agents - Core Components]] — LLM-based agents use transformer models
