...
## Related Notes
- [[Stats Review]] — statistics and probability foundations
- [[Lecture 2 — Model Evaluation (Experiments + Metrics + Basic Stats)]] — evaluation using statistical methods
- [[3 - Conditional Probability and Bayes]] — Bayes' theorem in probabilistic models
- [[Lecture 4 — Neural Networks & Backpropagation]] — neural nets as an alternative to explicit probability models
