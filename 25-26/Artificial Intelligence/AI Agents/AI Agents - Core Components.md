...
## Related Notes
- [[Building AI Agents]] — practical frameworks and protocols for building agents
- [[Further Topics on AI Agents]] — extended agent topics
- [[Overview Notes]] — formal multi-agent theory, agent architectures (BDI, MARBEL)
- [[LLMs]] — LLMs as the brain of AI agents
- [[03 - Embodied AI]] — agents with physical bodies; embodied perception-action loops
- [[K&D Notes]] — knowledge representation and retrieval (RAG foundations)
- [[Lecture 12 — Reinforcement Learning]] — RL as an alternative learning paradigm for agents
- [[Shaping AI Agent Behavior]] — behavioral modeling for agents
