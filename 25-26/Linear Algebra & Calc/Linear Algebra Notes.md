...
## Related Notes
- [[Lecture 1 — Linear Models & Optimization]] — linear models built on linear algebra
- [[Lecture 4 — Neural Networks & Backpropagation]] — matrix operations in neural nets
- [[Lecture 0 — What is ML]] — ML uses linear algebra throughout
- [[Stats Review]] — probability and statistics as the other math pillar of ML
- [[1 - Probability – Core Concepts]] — probability for quant trading
