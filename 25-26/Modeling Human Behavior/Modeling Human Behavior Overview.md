...
## Related Notes
- [[Agent-Based Modeling (ABM)]] — detailed ABM methodology
- [[Shaping AI Agent Behavior]] — applying behavior models to AI agents
- [[Overview Notes]] — formal multi-agent systems theory
- [[AI Agents - Core Components]] — AI agent architecture
- [[T5.1 - Learning]] — psychological learning theory underpinning behavioral models
- [[T7.2 - Decision-making]] — human decision-making processes
