...
## Related Notes
- [[Ontology Basics]] — ontologies as a form of structured knowledge
- [[Knowledge & Data/K&D Cheatsheet]] — quick reference for K&D concepts
- [[AI Agents - Core Components]] — RAG and knowledge bases in AI agents
- [[05 - Databases]] — database systems for storing knowledge
- [[Overview Notes]] — knowledge bases in multi-agent systems (Prolog KB)
